...
export default function Prices() {
  return (
    <section id="servicios" style={{ background: '#fafaf8', padding: 'clamp(48px, 8vw, 88px) clamp(20px, 4vw, 48px)' }}>
      <style>{`
        .prices-grid { display: grid; grid-template-columns: repeat(4,1fr); gap: 1px; background: #e2e0da; }
